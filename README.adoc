...
the Spring Web dependency. The following image shows the Initializr set up for the book
application:

image::images/initializr-book.png[]
...
image::images/initializr-gateway.png[]
